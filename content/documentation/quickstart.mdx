...
If you are still learning the product model, read [Workspace](/documentation/concepts/workspace) before wiring production flows.
...
If your flow depends on grouped audiences, review customer pools, target audience lists, cohort segments, and notification groups in [Core Concepts](/documentation/concepts).
...
- [Core Concepts](/documentation/concepts) for the product model.
