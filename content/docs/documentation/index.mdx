...
- [Quickstart](/docs/documentation/quickstart): the shortest path to understand the workspace, configure a handler, and send a test notification.
- [Core Concepts](/docs/documentation/concepts): product vocabulary and how the main Dokaai objects fit together.
- [Workspace](/docs/documentation/concepts/workspace): how organizations, projects, members, and services are organized.
- [Integration Overview](/docs/integration): where to connect Dokaai with channels, providers, and external systems.
- [API Reference](/docs/api-reference): generated endpoint documentation for automating Dokaai from your backend.
- [Authentication](/docs/api-reference/authentication): how API requests are authenticated.
- [Send Notification](/docs/api-reference/endpoints/send-notification): the main send endpoint entry point.
...
1. Read the [Quickstart](/docs/documentation/quickstart).
2. Review [Core Concepts](/docs/documentation/concepts).
3. Connect the required providers from [Integration](/docs/integration).
4. Test your first send flow from [Send Notification](/docs/api-reference/endpoints/send-notification).
5. Use the [API Reference](/docs/api-reference) for production automation.
